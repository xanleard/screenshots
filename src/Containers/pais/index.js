...
export const Pais = () => {
    ...
    const handleRemoverPaisClick = async () => {
        ...
        const response = await restClient.httpDelete('/PaisHacer', pais.id);
    ...
    const columns = [
        ...
        { key: 'column2', name: 'Pais', fieldName: 'nombre', minWidth: 100, maxWidth: 200, isResizable: true },     
    ]

    const isDisableButton = paises ? false : true;
